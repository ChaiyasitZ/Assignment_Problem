...
def main(): 
    ...
    # Example search for distance between Chumphon and Phuket
    print("Select a starting province:")
    print("1. Chumphon")
    print("2. Krabi")
    ...
    # Compute the total distance in kilometers by summing the edge weights
